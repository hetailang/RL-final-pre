...
\author{
\begin{tabular}{ll}
Name: \underline{\hspace{3cm}} & Student ID: \underline{\hspace{3cm}} \\
Name: \underline{\hspace{3cm}} & Student ID: \underline{\hspace{3cm}} \\
Name: \underline{\hspace{3cm}} & Student ID: \underline{\hspace{3cm}} \\
Name: \underline{\hspace{3cm}} & Student ID: \underline{\hspace{3cm}}
\end{tabular}
...
The project work was divided into four main parts. The responsible members are
left blank for now and can be filled in before submission.
...
\begin{table}[H]
  ...
  \begin{tabularx}{0.9\textwidth}{clX}
    ...
    \midrule
    1 & Project material collection & \underline{\hspace{4cm}} \\
    2 & Code implementation & \underline{\hspace{4cm}} \\
    3 & Presentation delivery & \underline{\hspace{4cm}} \\
    4 & Experimental report writing & \underline{\hspace{4cm}} \\
    \bottomrule
  \end{tabularx}
\end{table}
